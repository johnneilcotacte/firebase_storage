...
import 'package:new_flutter_assignment/modules/appbar/appbarbutton.dart';
import 'package:new_flutter_assignment/modules/appbar/divider/custom_divider.dart';
        ...
        child: Column(
          children: [
            ...
            AppBarButton(
              title: 'Bonus',
              onTap: () {
                Navigator.pushNamed(context, '${RouteGenerator.bonusRoute}',
                    arguments: ScreenArguments(null));
              },
            ),
          ],
